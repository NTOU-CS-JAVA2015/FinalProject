...
public class FontSize {
    ...
    JToolBar tbFontSize;
    MDIEditor MDIEditor;
    FontSize(JMenu mnFontSize, MDIEditor MDIEditorin) {
        ...
        FontSize.FontSizeAction fsaSize16 = new FontSize.FontSizeAction(
                "16(S)", new ImageIcon(imgSize16URL),
                "設定字體大小為16", KeyEvent.VK_S),
                fsaSize18 = new FontSize.FontSizeAction(
                        "18(M)", new ImageIcon(imgSize18URL),
                        "設定字體大小為18", KeyEvent.VK_M),
                fsaSize20 = new FontSize.FontSizeAction(
